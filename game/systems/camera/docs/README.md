...
This slice proves target following, code-driven orbit, and right-mouse mouse-look against a generic target proxy. Zoom, collision, and mode output are intentionally handled by later issue slices.
