"""Run Godot validation for the app quit handler."""
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Validate the app quit handler.")
...
def _resolve_godot(godot_path: str | None) -> str:
    ...
    raise SystemExit(
        "Godot is required for app quit handler validation but was not found on PATH. "
...
def main() -> int:
    ...
    script_path = repo_root / "tools/godot/validate_app_quit_handler.gd"
