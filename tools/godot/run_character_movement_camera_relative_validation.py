"""Run Godot validation for the camera-relative character movement slice."""
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Validate the camera-relative character movement slice.")
...
def _resolve_godot(godot_path: str | None) -> str:
    ...
    raise SystemExit(
        "Godot is required for character movement validation but was not found on PATH. "
...
def main() -> int:
    ...
    script_path = repo_root / "tools/godot/validate_character_movement_camera_relative_slice.gd"
