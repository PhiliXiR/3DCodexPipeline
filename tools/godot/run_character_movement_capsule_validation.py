"""Run Godot validation for the neutral character movement capsule slice."""
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Validate the neutral character movement capsule slice.")
...
def main() -> int:
    ...
    script_path = repo_root / "tools/godot/validate_character_movement_capsule_slice.gd"
