"""Run Godot validation for the character movement lateral input mode slice."""
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Validate character movement lateral input modes.")
...
def main() -> int:
    ...
    script_path = repo_root / "tools/godot/validate_character_movement_lateral_mode_slice.gd"
