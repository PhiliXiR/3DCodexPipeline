"""Run Godot validation for the generated neutral playground scene."""
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Validate the generated neutral playground scene.")
...
def _resolve_godot(godot_path: str | None) -> str:
    ...
    raise SystemExit(
        "Godot is required for playground validation but was not found on PATH. "
...
def main() -> int:
    ...
    script_path = repo_root / "tools/godot/validate_generated_neutral_playground_scene.gd"
