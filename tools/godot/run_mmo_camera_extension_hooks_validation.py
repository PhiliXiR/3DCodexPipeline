"""Run Godot validation for the MMO camera extension hooks slice."""
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Validate the MMO camera extension hooks slice.")
...
def main() -> int:
    ...
    script_path = repo_root / "tools/godot/validate_mmo_camera_extension_hooks_slice.gd"
