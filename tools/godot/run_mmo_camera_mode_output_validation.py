"""Run Godot validation for the MMO camera mode output slice."""
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Validate the MMO camera mode output slice.")
...
def main() -> int:
    ...
    script_path = repo_root / "tools/godot/validate_mmo_camera_mode_output_slice.gd"
