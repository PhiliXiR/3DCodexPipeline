"""Run Godot validation for the MMO camera mouse-look slice."""
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Validate the MMO camera mouse-look slice.")
...
def main() -> int:
    ...
    script_path = repo_root / "tools/godot/validate_mmo_camera_mouse_look_slice.gd"
