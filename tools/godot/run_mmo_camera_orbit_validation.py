"""Run Godot validation for the neutral MMO camera orbit slice."""
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Validate the neutral MMO camera orbit slice.")
...
def main() -> int:
    ...
    script_path = repo_root / "tools/godot/validate_mmo_camera_orbit_slice.gd"
