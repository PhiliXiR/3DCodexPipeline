"""Run Godot validation for the MMO controls cursor policy slice."""
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Validate the MMO controls cursor policy slice.")
...
def _resolve_godot(godot_path: str | None) -> str:
    ...
    raise SystemExit(
        "Godot is required for MMO controls validation but was not found on PATH. "
...
def main() -> int:
    ...
    script_path = repo_root / "tools/godot/validate_mmo_controls_cursor_policy_slice.gd"
