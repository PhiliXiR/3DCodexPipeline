"""Run Godot validation for the MMO controls mouse state slice."""
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Validate the MMO controls mouse state slice.")
...
def main() -> int:
    ...
    script_path = repo_root / "tools/godot/validate_mmo_controls_mouse_state_slice.gd"
